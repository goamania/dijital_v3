  ...
  return (
    <main className="min-h-screen pt-24 pb-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6">Site Bakımı</h1>
        <p className="text-xl text-slate-600 mb-8">Web sitenizin güvenli, hızlı ve güncel kalmasını sağlıyoruz.</p>
