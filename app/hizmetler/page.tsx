  ...
  return (
    <main className="min-h-screen pt-24 pb-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-xl text-slate-600 mb-12">İşletmeniz için ihtiyacınız olan tüm dijital çözümler tek çatı altında.</p>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {hizmetler.map((h) => (
            <Link key={h.href} href={h.href} className="bg-white rounded-2xl border border-slate-200 p-8 hover:shadow-lg hover:border-primary-300 transition-all">
              <h2 className="text-xl font-bold text-slate-900 mb-3">{h.title}</h2>
