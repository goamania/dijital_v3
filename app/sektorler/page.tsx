  ...
  return (
    <main className="min-h-screen pt-24 pb-16 bg-white dark:bg-slate-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl md:text-5xl font-bold text-slate-900 dark:text-white mb-4">Hizmet Verdiğimiz Sektörler</h1>
        <p className="text-xl text-slate-600 dark:text-slate-300 mb-12">Her sektörün ihtiyacına özel, deneyimle şekillendirilmiş çözümler.</p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {sektorler.map((s) => (
            <Link key={s.href} href={s.href} className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-700 p-8 hover:shadow-lg hover:border-primary-300 transition-all flex gap-6">
