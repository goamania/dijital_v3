...
const questions = {
  tr: {
    ...
    types: [
      { id: 'landing', label: 'Landing Page', desc: 'Tek sayfa, ürün veya kampanya tanıtımı', price: 15000 },
      { id: 'corporate', label: 'Kurumsal Web Sitesi', desc: 'Çok sayfalı, şirket tanıtım sitesi', price: 35000 },
      { id: 'ecommerce', label: 'E-ticaret Sitesi', desc: 'Online mağaza, ödeme sistemli', price: 75000 },
      { id: 'custom', label: 'Özel Proje', desc: 'Kompleks ihtiyaçlar, özel yazılım', price: 120000 },
    ],
    ...
    featureOptions: [
      { id: 'seo', label: 'SEO Optimizasyonu', price: 8000 },
      { id: 'multilingual', label: 'Çok Dilli Destek', price: 12000 },
      { id: 'blog', label: 'Blog / Haber Sistemi', price: 5000 },
      { id: 'booking', label: 'Randevu / Rezervasyon Sistemi', price: 10000 },
      { id: 'payment', label: 'Ödeme Entegrasyonu', price: 8000 },
      { id: 'admin', label: 'Özel Yönetim Paneli', price: 15000 },
    ],
  ...
  en: {
    ...
    types: [
      { id: 'landing', label: 'Landing Page', desc: 'Single page promotion', price: 500 },
      { id: 'corporate', label: 'Corporate Website', desc: 'Multi-page company website', price: 1000 },
      { id: 'ecommerce', label: 'E-commerce Site', desc: 'Online store with payments', price: 2200 },
      { id: 'custom', label: 'Custom Project', desc: 'Complex needs, custom software', price: 3600 },
    ],
    ...
    featureOptions: [
      ...
      { id: 'multilingual', label: 'Multi-language', price: 350 },
      { id: 'blog', label: 'Blog / News System', price: 150 },
      { id: 'booking', label: 'Booking System', price: 300 },
      { id: 'payment', label: 'Payment Integration', price: 250 },
      { id: 'admin', label: 'Custom Admin Panel', price: 450 },
    ],
